 ...
 */
public class WinetricksParser extends AbstractFileParser<JavaPackage> {
    ...
    public static List<JavaPackage> filterPackages(JavaDownloadEnvironment jde) {
        ...
        try {
            WinetricksParser parser = new WinetricksParser(ClassLoader.getSystemResourceAsStream("Java.gz"));
    ...
    public static void main(String[] args) {
        try {
            WinetricksParser parser = new WinetricksParser("Java.gz");
            while (parser.hasNext()) {
                JavaPackage pkg = parser.next();
